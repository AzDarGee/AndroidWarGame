...
import oscf.AbstractServer;
import oscf.ConnectionToClient;
import oscf.ServerConsole;
...
public class Server extends AbstractServer 
{
	...
	public void handleMessageFromClient(Object msg, ConnectionToClient client) {
		...
		if (message.contains("#login")) {
			...
			if(message.contains("#getClientID"))
			{
				this.sendToAllClients("#setsClientID" + nextClientID);
			}
